...
impl Message {
    ...
    pub fn serialize(&self) -> io::Result<Vec<u8>> {
        let msg = p2p::Message {
            message: Some(p2p::message::Message::Put(self.msg.clone())),
        };
    ...
    pub fn deserialize(d: impl AsRef<[u8]>) -> io::Result<Self> {
        ...
        match p2p_msg.message.unwrap() {
            // was not compressed
            p2p::message::Message::Put(msg) => Ok(Message {
                msg,
                gzip_compress: false,
            }),
...
/// RUST_LOG=debug cargo test --package avalanche-types --lib -- message::put::test_message --exact --show-output
#[test]
fn test_message() {
